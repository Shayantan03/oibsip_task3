let celsius = document.getElementById('celsius_scale');
let fahrenheit = document.getElementById('fahrenheit_scale');
let kelvin = document.getElementById('kelvin_scale');
